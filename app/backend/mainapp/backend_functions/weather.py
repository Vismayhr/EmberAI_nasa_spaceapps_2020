...
def get_weather(datetime_string="2020-10-04T00:10:00ZP0D:PT1H", coordinates_string="47.4245,9.3767+45.41,8.9"):	
	...
	response = requests.get(f"https://{username}:{password}@api.meteomatics.com/{datetime_string}/precip_10min:mm,relative_humidity_2m:p,wind_speed_100m:ms,direct_rad:W/{coordinates_string}/json?model=mix")
